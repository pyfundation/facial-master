...
import { FaceScannerApiService } from './facescanner-api.service';
import { environment } from '../../environments/environment';
import { Person } from '../models/person';
import { FacePhoto } from '../models/face-photo';

describe('FaceScannerApiService', () => {
  let injector: TestBed;
  let service: FaceScannerApiService;
  let httpMock: HttpTestingController;

  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [FaceScannerApiService],
      imports: [
    ...
    injector = getTestBed();
    service = injector.get(FaceScannerApiService);
    httpMock = injector.get(HttpTestingController);

  });

  it('should be created', inject([FaceScannerApiService], (service: FaceScannerApiService) => {
